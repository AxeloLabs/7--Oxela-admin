...
searchProductDescriptionUsingL2similarityRef.operationName =
  'SearchProductDescriptionUsingL2Similarity';
exports.searchProductDescriptionUsingL2similarityRef =
  searchProductDescriptionUsingL2similarityRef;

exports.searchProductDescriptionUsingL2similarity =
  function searchProductDescriptionUsingL2similarity(dcOrVars, vars) {
    return executeQuery(
      searchProductDescriptionUsingL2similarityRef(dcOrVars, vars)
    );
  };
...
searchProductTitleUsingL2similarityRef.operationName =
  'SearchProductTitleUsingL2Similarity';
exports.searchProductTitleUsingL2similarityRef =
  searchProductTitleUsingL2similarityRef;

exports.searchProductTitleUsingL2similarity =
  function searchProductTitleUsingL2similarity(dcOrVars, vars) {
...
searchProductReviewContentUsingL2similarityRef.operationName =
  'SearchProductReviewContentUsingL2Similarity';
exports.searchProductReviewContentUsingL2similarityRef =
  searchProductReviewContentUsingL2similarityRef;

exports.searchProductReviewContentUsingL2similarity =
  function searchProductReviewContentUsingL2similarity(dcOrVars, vars) {
    return executeQuery(
      searchProductReviewContentUsingL2similarityRef(dcOrVars, vars)
    );
  };
...
exports.updateOrderByPaymentIntentId = function updateOrderByPaymentIntentId(
  dcOrVars,
  vars
) {
